...
def generate_launch_description():
  ...
  yaw = 4.71238898 # 270 degrees

  randomized = randomize_poses()

  for index, x_coord, y_coord, shape, num in randomized:
    load_nodes.append(Node(
      ...
      parameters=[{
        'world': world,
        'file': general_filepath + '/default_platform/model.sdf',
        'string': '', # unused
        'topic': '', # unused
        'name': f'base{index}',
    ...
    load_nodes.append(Node(
      ...
      parameters=[{
        'world': world,
        'file': general_filepath + f'/bouncing/shapes/{shape}/model.sdf',
        'string': '', # unused
        'topic': '', # unused
        'name': f'shape{index}',
        'allow_renaming': 'False',
    ...
    load_nodes.append(Node(
      ...
      parameters=[{
        'world': world,
        'file': general_filepath + f'/bouncing/{num}/model.sdf',
        'string': '', # unused
        'topic': '', # unused
        'name': f'figure{index}',
        'allow_renaming': 'False',
